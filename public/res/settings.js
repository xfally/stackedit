define([
	...
	var settings = {
		...
		template: [
			...
			'<link rel="stylesheet" href="' + constants.BASE_URL + 'res-min/themes/base.css" />',
			'<script type="text/javascript" src="' + constants.BASE_URL + 'res/bower-libs/MathJax/MathJax.js?config=TeX-AMS_HTML"></script>',
			'</head>',
